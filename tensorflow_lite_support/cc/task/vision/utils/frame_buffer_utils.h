...
#include "third_party/tensorflow_lite_support/cc/task/vision/utils/frame_buffer_utils_interface.h"
...
// Returns the `from_box` in `from_orientation` to `to_orientation` within an
// image (width, height) in `from_orientation`.
